...
export const CASE_STUDIES = [
  {
    ...
    lesson: 'Jobs hired for love of the mission, not credentials. His test: will they fall in love with Apple? The Mac team had fewer resources than the Lisa team but produced the product that changed personal computing. EQ compensated for constrained money and time.',
  },
  {
    id: 'pixar-ts2',
    name: 'Pixar, Toy Story 2 (1999)',
    accent: '#14B8A6',
    accentName: 'teal',
    values: { money: 60, time: 20, quality: 95, eq: 95 },
    oneLiner: 'Scrapped the entire movie with 9 months left. Shipped a masterpiece.',
    lesson: 'The team worked six-day weeks for nine months. 30% developed repetitive strain injuries. The result: $497M gross, rave reviews. Ed Catmull\'s insight: give a mediocre idea to a brilliant team and they will fix it. But this also shows the cost of extreme EQ. Passion without boundaries hurt people.',
  },
  {
    id: 'whatsapp',
    ...
    lesson: 'Individual teams of 1-3 engineers with complete autonomy. No ads, no social feed, no feature creep. By doing less, they moved faster. Low money forced optionality into radical focus. High EQ meant engineers took extreme ownership.',
  },
  {
    id: 'leicester',
    ...
    accent: '#8B5CF6',
    accentName: 'purple',
    values: { money: 15, time: 70, quality: 60, eq: 95 },
    oneLiner: '5,000-to-1 odds. Won the Premier League.',
    lesson: 'Squad cost 58.2 million pounds versus hundreds of millions for rivals. Manager Ranieri made only 33 starting lineup changes all season (fewest by any champion). Team chemistry was off the charts. Meanwhile Chelsea\'s defending champions imploded when Mourinho lost the dressing room. Same league, same rules. Different EQ, different outcomes.',
  },
  {
    id: 'spacex-boeing',
    name: 'SpaceX vs Boeing',
    accent: 'split',
    accentName: 'split',
    isComparative: true,
    values: { money: 45, time: 65, quality: 85, eq: 90 },
    comparisonValues: { money: 75, time: 30, quality: 50, eq: 35 },
    comparisonLabel: 'Boeing',
    oneLiner: '40% less funding. Delivered 4 years earlier. Half the cost per seat.',
    lesson: 'NASA gave Boeing $4.2B and SpaceX $2.6B for the same mission. SpaceX delivered first crewed flight in 2020. Boeing delivered in 2024, seven years late. SpaceX engineers were described as collaborative and receptive. Boeing engineers were often dismissive of astronaut feedback. More money with less EQ produced a smaller outcome than less money with more EQ.',
  },
  {
    id: 'nummi',
    name: 'NUMMI / Toyota (1984)',
    accent: '#14B8A6',
    accentName: 'teal',
    values: { money: 50, time: 60, quality: 90, eq: 85 },
    oneLiner: 'Same workers. Same factory. Radically different results.',
    lesson: 'Before Toyota: 20% absenteeism, worst quality in the industry, workers hiding bottles in car doors. After Toyota reopened with 85% of the same workforce: 2% absenteeism, lowest defect rates in the US. The difference was not the people. It was whether the people felt respected, empowered, and trusted. Taiichi Ohno: there is no limit to people\'s creativity.',
  },
];
